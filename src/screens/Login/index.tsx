...
const Login = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <TouchableOpacity>
          <Text style={styles.text}>{t('Quên mật khẩu')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles.text}>
            {showPassword ? t('Hiển thị mật khẩu') : t('Ẩn mật khẩu')}
          </Text>
        </TouchableOpacity>
      </View>
      <View style={{marginTop: 50}}>
        <View style={{alignItems: 'center'}}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.txtLogin}>{t('Đăng nhập')}</Text>
          </TouchableOpacity>
        </View>
      </View>
      <Separator />
